...
open class BaseRouter {
    public let moduleViewController: UIViewController

    public init(moduleViewController: UIViewController) {
        self.moduleViewController = moduleViewController
    }

    public func present(_ router: BaseRouter, completion: (() -> Void)? = nil) {
    ...
    public func modal(_ router: BaseRouter, completion: (() -> Void)? = nil) {
        let viewController = router.moduleViewController
    ...
    public func presentNavigation(_ router: BaseRouter, completion: (() -> Void)? = nil) {
    ...
    public func push(_ router: BaseRouter) {
