...
class CMViewController: UIViewController, WKNavigationDelegate, UIScrollViewDelegate {
    //MARK:- @IBOutlet
    ...
    private let loginURL = "https://eweb.stud.tokushima-u.ac.jp/Portal" // 情報ポータルURL
