...
class Model: NSObject {
    ...
    let urls = ["login" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/", topView: true),
                "courceManagementHomeSP" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/sp/Top.aspx", topView: true),
                "courceManagementHomePC" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/Top.aspx", topView: true),
                "manabaSP" : structURL(url: "https://manaba.lms.tokushima-u.ac.jp/s/home_summary", topView: true),
                "manabaPC" : structURL(url: "https://manaba.lms.tokushima-u.ac.jp/ct/home", topView: true),
                "libraryLogin" : structURL(url: "https://opac.lib.tokushima-u.ac.jp/opac/user/top", topView: true),
                "libraryBookLendingExtension" : structURL(url: "https://opac.lib.tokushima-u.ac.jp/opac/user/holding-borrowings", topView: true),
                "libraryBookPurchaseRequest" : structURL(url: "https://opac.lib.tokushima-u.ac.jp/opac/user/purchase_requests/new", topView: true),
                "syllabusSearchMain" : structURL(url: "http://eweb.stud.tokushima-u.ac.jp/Portal/Public/Syllabus/SearchMain.aspx", topView: true),
                "timeTable" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/Regist/RegistList.aspx", topView: true),
                "currentTermPerformance" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/Sp/ReferResults/SubDetail/Results_Get_YearTerm.aspx?year=", topView: true),
                "termPerformance" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/ReferResults/Menu.aspx", topView: true),
                "presenceAbsenceRecord" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/Attendance/AttendList.aspx", topView: true),
                ...
                "systemServiceList" : structURL(url: "https://www.ait.tokushima-u.ac.jp/service/list_out/", topView: true),
                "eLearningList" : structURL(url: "https://uls01.ulc.tokushima-u.ac.jp/info/index.html", topView: true),
                "outlookHome" : structURL(url: "https://outlook.office.com/mail/", topView: true),
                "tokudaiCareerCenter" : structURL(url: "https://www.tokudai-syusyoku.com/index.php", topView: true),
                "libraryHome" : structURL(url: "https://www.lib.tokushima-u.ac.jp/", topView: true),
                "lostConnection" : structURL(url: "https://localidp.ait230.tokushima-u.ac.jp/idp/profile/SAML2/Redirect/SSO?execution=", topView: false),
                "libraryCalendar" : structURL(url: "https://www.lib.tokushima-u.ac.jp/pub/pdf/calender/calender_main_", topView: false),
                "syllabus" : structURL(url: "http://eweb.stud.tokushima-u.ac.jp/Portal/Public/Syllabus/", topView: false),
                "timeOut" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/RichTimeOut.aspx", topView: false),
                "enqueteReminder" : structURL(url: "https://eweb.stud.tokushima-u.ac.jp/Portal/StudentApp/TopEnqCheck.aspx", topView: false),
                "popupToYoutube" : structURL(url: "https://manaba.lms.tokushima-u.ac.jp/s/link_balloon", topView: false),
                "mailService" : structURL(url: "https://outlook.office365.com/tokushima-u.ac.jp", topView: false),
                "outlookLogin" : structURL(url: "https://wa.tokushima-u.ac.jp/adfs/ls", topView: false),]
